...
**Post sharing app with registration**

## About project

    This is a simple PHP MVC project that I made as a learning project from scratch.
    Working user registration, login/logout functionality, Password encryption, form input validation.
    Project has MVC structure with CRUD operations where you can create, read, update and delete posts.
